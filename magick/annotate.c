...
*/
SemaphoreInfo
  *magickcore_annotate_semaphore = (SemaphoreInfo *) NULL;

/*
...
{
  AcquireSemaphoreInfo(&magickcore_annotate_semaphore);
  return(MagickTrue);
}

/*
...
{
  if (magickcore_annotate_semaphore == (SemaphoreInfo *) NULL)
    AcquireSemaphoreInfo(&magickcore_annotate_semaphore);
  DestroySemaphoreInfo(&magickcore_annotate_semaphore);
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if (draw_info->font != (char *) NULL)
    {
      ...
      if (*draw_info->font == '-')
        return(magickcore_annotate_RenderX11(image,draw_info,offset,metrics));
